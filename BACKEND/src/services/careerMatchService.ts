...
Quote every CV excerpt and job requirement verbatim from its source. Score four bounded components, not a total: requirementsMatch 0-45, relevantExperience 0-25, demonstratedSkills 0-20, evidenceQuality 0-10. Use the full component ranges. Employment evidence is stronger than project evidence, and a skills-list mention alone is weak. Do not treat Job Match as a hiring probability.

Return exactly: {"mode":"vacancy_match","inferredJobTitle":"string","summary":"string","matchBreakdown":{"requirementsMatch":0,"relevantExperience":0,"demonstratedSkills":0,"evidenceQuality":0},"matchedRequirements":[{"requirement":"exact job requirement","cvEvidence":"exact CV excerpt","explanation":"string"}],"partialRequirements":[{"requirement":"exact job requirement","cvEvidence":"exact CV excerpt","explanation":"string"}],"missingRequirements":[{"requirement":"exact job requirement","explanation":"string"}],"recommendations":[{"action":"string","evidence":{"cvExcerpt":"exact CV excerpt","jobRequirement":"exact job requirement","rationale":"string"}}],"alternativeRoles":["string"]}. Do not return jobMatchScore or cvQualityScore; the server calculates them.${langInstruction}`,
        },
        {
          role: "user",
